...
GRAPHITRON_BUILD_DIRECTORY="/Users/vesperal_kite/important_files/Graphitron/build_test".strip().rstrip('/')
GRAPHITRON_SOURCE_DIRECTORY="/Users/vesperal_kite/important_files/Graphitron".strip().rstrip('/')
