...
namespace graphit {
    ...
    public:
        ...
        int emitapply_kernel_mk(std::ostream &oss);
        int emitbuild_mk(std::ostream &oss,graphit::ThunderGP_Schedule::Partition partitionschedule);
        int emitconfig_mk(std::ostream &oss);
        int emitdataPrepare_cpp(std::ostream &oss);
        int emitmain_cpp(std::ostream &oss);
