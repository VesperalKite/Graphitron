...
namespace graphit {
 ...
 ///////////////////////////////////////   
    struct ThunderGP_Schedule
    {
        enum class Partition{
            normal,
            secondOrderEstimator
        };
        Partition partition = {Partition::secondOrderEstimator};
        graphit::ThunderGP_Schedule * thundergp_mp;
          ///////////////////////////////////////////////////////////////////////////////
    public:
        void setThunderGPpartition(ThunderGP_Schedule::Partition type){
            thundergp_mp = new ThunderGP_Schedule();
            thundergp_mp->partition = type;
        }
    };
    ...
    public: 
        ...
        public:
            Schedule() {
                ...
                thundergp_schedule = new ThunderGP_Schedule;
            ...
            ThunderGP_Schedule *thundergp_schedule;
