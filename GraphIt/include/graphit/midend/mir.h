...
//            }
        ...
        struct ScalarType : public Type {
            enum class Type {
                INT, UINT, UINT_64, FLOAT, DOUBLE, BOOL, COMPLEX, STRING, PROP_T
            };
            Type type;
            ...
            std::string toString(){
                ...
                if (type == mir::ScalarType::Type::FLOAT){
                    ...
                    output_str = "string";
                } else if (type == mir::ScalarType::Type::PROP_T)
                {
                    output_str = "prop_t";
                }
                return output_str;
        ...
        struct LshExpr : public BinaryExpr{
            typedef std::shared_ptr<LshExpr> Ptr;

            virtual void accept(MIRVisitor *visitor){
                visitor->visit(self<LshExpr>());
            }
        ...
        struct RshExpr : public BinaryExpr{
            typedef std::shared_ptr<RshExpr> Ptr;

            virtual void accept(MIRVisitor *visitor){
                visitor->visit(self<RshExpr>());
            }
