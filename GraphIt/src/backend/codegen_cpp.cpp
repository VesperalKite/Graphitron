...
namespace graphit {
    ...
    void CodeGenCPP::genDefineStmts() {
...
*/
    ...
    void CodeGenCPP::visit(mir::FuncDecl::Ptr func_decl) {
        ...
        if (func_decl->name == "main") {
            ...
            oss << "inline prop_t " << func_decl->name <<"(";
            bool printDelimiter = false;
            ...
            for (auto arg : func_decl->args) {
                ...
                arg.getType()->accept(this);
                if (arg.getName() == "extra"){
                    oss << "(&extra)[APPLY_REF_ARRAY_SIZE]";
                }
                else{
                    oss << arg.getName();
                }
    ...
    void CodeGenCPP::visit(mir::ScalarType::Ptr scalar_type) {
        switch (scalar_type->type) {
            case mir::ScalarType::Type::PROP_T:
                oss << "prop_t ";
                break;
 ...
 */
    ...
    void CodeGenCPP::visit(mir::LshExpr::Ptr expr){
        oss << '(';
        expr->lhs->accept(this);
        oss << " << " ;
        expr->rhs->accept(this);
    ...
    void CodeGenCPP::visit(mir::RshExpr::Ptr expr){
        oss << '(';
        expr->lhs->accept(this);
        oss << " >> " ;
        expr->rhs->accept(this);
